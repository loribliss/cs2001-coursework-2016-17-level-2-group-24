...
public class InitialiseShoppingListArray
{
    ...
    public static void initialiseArray()
    {
        ...
        masterListShoppingItems.add(new ShoppingListItem("Chicken fillets", "1", "Medium", "18/02/17", false));
        masterListShoppingItems.add(new ShoppingListItem("Bran Flakes", "3", "Low", "13/02/17", false));
        masterListShoppingItems.add(new ShoppingListItem("Bread", "1", "High", "21/02/17", false));
        masterListShoppingItems.add(new ShoppingListItem("Turkey", "3", "Medium", "19/02/17", false));
    }
