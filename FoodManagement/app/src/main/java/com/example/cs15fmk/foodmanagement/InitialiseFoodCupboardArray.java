...
public class InitialiseFoodCupboardArray
{
    ...
    public static void initialiseArray()
    {
        ...
        masterListFoodCupboardItems.add(new FoodCupboardItem("Beef", "01/01/2017", "28/02/2017", "5", "QUANTITY&AMOUNT", "3","1","1000","450"));
        masterListFoodCupboardItems.add(new FoodCupboardItem("Milk", "01/01/2017", "24/02/2017", "5", "AMOUNT", "1","1","2000", "500"));
        masterListFoodCupboardItems.add(new FoodCupboardItem("Wholemeal Rolls", "23/01/2017", "03/03/2017", "2","QUANTITY","4","2","0","0"));
        masterListFoodCupboardItems.add(new FoodCupboardItem("Turkey rashers", "07/02/2017", "10/03/2017", "14", "AMOUNT", "1", "1","8","2"));
    }
